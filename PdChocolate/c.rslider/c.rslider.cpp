...
void slider_set(t_slider *x, t_symbol* s, long argc, t_atom* argv);
void slider_list(t_slider *x, t_symbol* s, long argc, t_atom* argv);
...
void draw_knob(t_slider *x, t_object *view, t_rect *rect);
...
extern "C" void setup_c0x2erslider(void)
{
	...
	c = eclass_new("c.rslider", (method)slider_new, (method)slider_free, (short)sizeof(t_slider), 0L, A_GIMME, 0);
    ...
    eclass_addmethod(c, (method) slider_set,             "set",              A_GIMME,0);
    eclass_addmethod(c, (method) slider_list,            "list",             A_GIMME,0);
    ...
    CLASS_ATTR_LONG                 (c, "listmode", 0, t_slider, f_mode);
