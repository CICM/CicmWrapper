...
void ccolorpanel_setup(void)
{
	t_eclass *c;
    
	c = eclass_new("ccolorpanel", (method)colorpanel_new, (method)colorpanel_free, (short)sizeof(t_colorpanel), 0L, A_GIMME, 0);
    class_addcreator((t_newmethod)colorpanel_new, gensym("swatch"), A_GIMME, 0);
	eclass_init(c, 0);
...
void *colorpanel_new(t_symbol *s, int argc, t_atom *argv)
{
	...
	x = (t_colorpanel *)ebox_alloc(colorpanel_class);
