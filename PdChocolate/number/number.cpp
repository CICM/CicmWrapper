...
extern "C" void number_setup(void);
...
extern "C" void number_setup(void)
{
	...
	c = eclass_new("number", (method)number_new, (method)number_free, (short)sizeof(t_number), 0L, A_GIMME, 0);
    class_addcreator((t_newmethod)number_new, gensym("numbox"), A_GIMME, 0);
...
void draw_background(t_number *x, t_object *view, t_rect *rect)
{
	...
	if (g && jtl)
	{
        etext_layout_set(jtl, "©", &x->j_box.e_font, 1.5, rect->height / 2., rect->width, 0, ETEXT_LEFT, ETEXT_NOWRAP);
