...
void patcherinfos_setup(void)
{
	t_eclass *c;
    
	c = eclass_new("patcherinfos", (method)patcherinfos_new, (method)patcherinfos_free, (short)sizeof(t_patcherinfos), 0L, A_GIMME, 0);
...
void *patcherinfos_new(t_symbol *s, int argc, t_atom *argv)
{
    ...
    x = (t_patcherinfos *)ebox_alloc(patcherinfos_class);
    if(x)
    {
